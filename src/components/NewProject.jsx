...
const style = {
  ...
  button:
    "px-8 py-4 mx-auto mt-12 text-2xl tracking-wide uppercase transition-all duration-300 peer/button bg-emerald-700 text-amber-200 rounded-xl hover:text-emerald-700 hover:bg-amber-200 hover:scale-105",
  line: "mt-2 text-transparent mx-auto w-0 peer-hover/button:w-xl h-[3px] peer-hover/button:bg-emerald-700 border transition-all duration-700",
};

export default function NewProject({ addNewProject, closeModal }) {
      ...
      >
        ...
        <div className={style.inputWrapper}>
          ...
          <textarea
            ref={descriptionRef}
            className={
              style.input + "whitespace-pre-wrap resize-none max-h-[150px]"
            }
            id='description'
